...
const LEGEND = [
	...
	"response  time until the assistant response stream starts",
	"ttft      time until the first non-empty text delta; omitted without text",
	"think     observed thinking-window time / provider-reported reasoning tokens",
	"tools     elapsed tool wall time",
	"tokens    provider-reported total; includes reasoning tokens when applicable",
